...
function DantooineStaticSpawnsScreenPlay:spawnMobiles()
	...
	local pNpc = spawnMobile("dantooine", "force_crystal_hunter", 1800,902.4,19.8,1395.4,-114,0)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile("dantooine", "force_crystal_hunter", 1800,892.3,21.2,1390.4,-176,0)
	self:setMoodString(pNpc, "angry")

	--old tower with green fire
	pNpc = spawnMobile("dantooine", "force_sensitive_renegade", 1800,-924.1,7.5,6917.9,72,0)
	self:setMoodString(pNpc, "angry")
	pNpc = spawnMobile("dantooine", "force_sensitive_renegade", 1800,-914.8,7.8,6904.4,155,0)
	self:setMoodString(pNpc, "angry")
